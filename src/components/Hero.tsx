...
const Hero = () => {
    ...
    useEffect(() => {
        ...
        gsap.fromTo(
            titleRef.current,
            { y: 100, opacity: 0 },
            { y: 0, opacity: 1, duration: 1, stagger: 0.3, ease: "ease.out" }
        );
            ...
            <div className="min-h-screen w-full flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                <div className="h-full w-full md:w-1/2 order-last md:order-first">
                    <div className="overflow-hidden">
                        <h1
                            ref={addToRefs}
                            className="text-[28px] md:text-[24px] lg:text-[36px]"
                        >
                            Hello I'am{" "}
                    ...
                    <div className="overflow-hidden">
                        <h1
                            ref={addToRefs}
                            className="text-[32px] md:text-[24px] lg:text-[40px]"
                        >
                            MERN Stack{" "}
                    ...
                    <div className="overflow-hidden">
                        <h1
                            ref={addToRefs}
                            className="text-[36px] md:text-[28px] lg:text-[44px] font-bold"
                        >
                            Bangladesh 2.0
                        </h1>
                    </div>
                    <div className="overflow-hidden ">
                        <p
                            ref={addToRefs}
                            className=" text-[16px] lg:text-[18px] my-4 lg:my-10 text-zinc-600"
                        >
                            I am Mehedi Hassan, a passionate MERN stack
                            developer with a knack for creating dynamic,
                            full-stack web applications. My expertise spans from
                            building seamless user interfaces to managing robust
                            backend services. I'm dedicated to leveraging the
                            latest technologies to deliver high-quality
                            solutions.
                        </p>
                    </div>
                    <div className="overflow-hidden">
