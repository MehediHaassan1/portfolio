    ...
    return (
        <div id="skills" ref={containerRef} className="container mx-auto my-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 items-center justify-between gap-6">
                {skills.map((item, idx) => (
                    <div key={idx} className="size-44  mx-auto border border-black rounded relative group flex items-center justify-center hover:text-white hover:bg-black duration-500 transition-all">
                        {item.icon}
